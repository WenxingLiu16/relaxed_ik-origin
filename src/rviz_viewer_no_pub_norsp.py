...
def joint_group_position_define(xopt):
...
if __name__ == '__main__':
    ...
    js_pub = rospy.Publisher('/joint_group_position_controller/command',Float64MultiArray,queue_size=1)
    ...
    while not rospy.is_shutdown():
        ...
        js = joint_group_position_define(xopt)
        now = rospy.Time.now()
        js_pub.publish(js)
